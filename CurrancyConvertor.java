...
class Currancy{
    void converter(){
        ...
        first.setBounds(250,30,100,30);
        frame.add(first);
        JTextField second = new JTextField();
        second.setBounds(250,80,100,30);
        frame.add(second);
        JButton convert = new JButton("Convert");
        Font font = new Font("serif",Font.BOLD,25);
        frame.setFont(font);
        convert.setBounds(100,150,150,40);
        convert.setBackground(Color.gray);
        convert.setForeground(Color.lightGray);
        frame.add(convert);
        ...
        combo1.setForeground(Color.gray);
